...
namespace FriendsOfTYPO3\FontawesomeProvider\Imaging\IconProvider;
...
class FontawesomeIconProvider implements IconProviderInterface
{
    ...
    {
        /** @var array<string, string>|false $icons */
    ...
    protected function createSvgIcons(): array
    {
        ...
        foreach ($this->unicodeMap as $name => $unicode) {
            ...
            if ($elements === null || $elements === false || count($elements) === 0) {
            ...
            $svg = vsprintf(
                '<svg xmlns="http://www.w3.org/2000/svg" viewBox="%s %s %s %s" class="icon-unify"><path transform="scale(1 -1)" transform-origin="%s %s" class="icon-color" d="%s" /></svg>',
                $this->escape([
                    $viewBoxXOffset,
                    $viewBoxYOffset,
                    $width,
    ...
    /**
     * @param array<int, int|float|string> $strings
     * @return string[]
     */
